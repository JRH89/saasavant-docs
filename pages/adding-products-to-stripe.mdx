...
Ensure you save the .env file after pasting in the Price IDs.
Repeat for Additional Products:

If you have multiple products, repeat the process to add each product&apos;s Price ID to the .env file.
