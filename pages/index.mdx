...
- Coupon codes: Offer discounts and promotional pricing.
...
- **Pagination**: Display users in pages, with a limit of 50 users per page and scrolling after the first 10 for ease of navigation.

#### Announcements

- **Create Announcements**: Admins can create and publish announcements to be displayed to all users. This feature supports text and provides an easy interface to manage important updates.
...
- **Access Support Tickets**: View their submitted support tickets and track their status.
...
- **Reset Password**: Easily reset their password if they forget it.
...
- Clicking the "Manage Subscription" button from their user account page will take them straight to their Stripe account using the Stripe URL.
