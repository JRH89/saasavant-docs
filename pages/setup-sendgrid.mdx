...
- Locate the `.env` file or create one if it doesn&apos;t exist.
- Add your SendGrid API key to the `.env` file as follows:
...
Set the verified email address as the **From** address in your SendGrid configuration within your application (located in the `.env` file).